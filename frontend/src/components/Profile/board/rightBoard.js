...
class RightBoard extends Component {
  ...
  updateBackground() {
    ...
    board.className = `w-[408px] h-[632px] left-0 top-0 absolute bg-primary-card_background dark:bg-secondary-card_background rounded-2xl border-[12px] border-${backgroundColors[Store.state.background]}`;
  }
